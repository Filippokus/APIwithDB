...
4	6	помыть квартиру с дезинфицирующими средствами, провертрить и убрать все опасные предметы	t
...
1	17	можно только на закрытой площадке для собак	t
2	17	узнать у владельца разрешает ли он так делать и только на закрытой площадке для собак	t
3	17	да можно, поиграют и все, никуда не денется	f
4	17	нельзя, собака на передержке должна выгуливаться только на поводке, даже если владелец просит об обратном, все равно нет, исключения закрытые площадки для собак	t
1	18	побегу за ней, чтобы поймать	f
2	18	буду кричать «ко мне» и стоять на месте	f
3	18	буду спокоен, присяду на корточки и добрым голосом буду заманивать к себе показывая в руке лакомство, шурша пакетиком, делая вид что все в порядке, смотри у меня для тебя есть угощение или поманю игрушкой или палкой чтобы она прибежала ко мне поиграть	t
4	18	буду кричать и просить окружающих поймать собаку	f
1	19	отсматривать собак на наличие повреждений, царапин и ссадин, а также на наличие клещей	t
2	19	мыть лапы и вытирать их насухо	t
3	19	кормить собаку	t
4	19	высылать фото и видео владельцу	t
1	20	можно	f
2	20	нельзя	t
3	20	нужно узнать у владельца разрешает ли он	f
\.
...
COPY petsitters.gamequestion (questionid, questiontext) FROM stdin;
1	Что нужно узнать у владельца перед передержкой?
2	Что нужно сделать до передержки??
3	Как правильно знакомить собак на передержке?
4	При каких условиях владелец может попросить заранее познакомиться с ситтером?
5	Как правильно знакомить собак?
6	Как подготовить квартиру к передержке?
7	Как правильно знакомиться с собакой?
8	Как должен себя вести ситтер если собака на первой встрече проявляет к нему агрессию или боится его?
9	Какие антистресс игрушки желательно чтобы владелец собаки положил с вещами для питомца?
10	Как помочь собаке адаптироваться на новом месте и снизить стресс от разлуки с хозяином?
11	Что делать если собака воет, скулит и лает после того как ушел хозяин?
12	Что делать если собака начала метить углы мебели, шкафы в вашем доме?
13	В чем отличие передержки щенка от передержки взрослой собаки?
14	Сколько раз в день нужно высылать фото и видео отчет о состоянии собаки?
15	Если собака стала себя хуже чувствовать , пропал аппетит, появилась рвота или кашель и симптомы простуды, что нужно делать?
16	 Что должен сделать догситтер если собака на прогулке схватила что-то с земли и попытается съесть?
17	Во время прогулки с собакой, можно ли отпускать ее с поводка поиграть и побегать с другими собаками?
18	Если собака сорвалась с поводка и убегает, ваши действия:
19	Что важно делать после каждой прогулки?
20	Можно ли брать на кровать маленького щенка или миниатюрную собаку?
\.
...
SELECT pg_catalog.setval('petsitters.gamequestion_questionid_seq', 20, true);
...
SELECT pg_catalog.setval('petsitters.user_userid_seq', 1, true);
